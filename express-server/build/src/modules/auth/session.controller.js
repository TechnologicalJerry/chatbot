...
function createUserSessionHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, session, accessTokenTtl, refreshTokenTtl, accessToken, refreshToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    session = _a.sent();
                    accessTokenTtl = config_1.default.has("accessTokenTtl") ? config_1.default.get("accessTokenTtl") : "15m";
                    refreshTokenTtl = config_1.default.has("refreshTokenTtl") ? config_1.default.get("refreshTokenTtl") : "1y";
                    accessToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), "accessTokenPrivateKey", { expiresIn: accessTokenTtl });
                    refreshToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), "refreshTokenPrivateKey", { expiresIn: refreshTokenTtl });
