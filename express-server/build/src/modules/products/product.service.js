    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, product_model_1.default.create(input)];
                case 2:
                    result = _a.sent();
...
function findProduct(query, options) {
    if (options === void 0) { options = { lean: true }; }
    return __awaiter(this, void 0, void 0, function () {
        var metricsLabels, timer, result, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    metricsLabels = {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, product_model_1.default.findOne(query, {}, options)];
                case 2:
                    result = _a.sent();
                    timer(__assign(__assign({}, metricsLabels), { success: "true" }));
                    return [2 /*return*/, result];
...
function deleteProduct(query) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, product_model_1.default.deleteOne(query)];
        });
    });
}
