...
var session_service_1 = require("../../modules/auth/session.service");
var deserializeUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, refreshToken, _a, decoded, expired, newAccessToken, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = (0, jwt_utils_1.verifyJwt)(accessToken, "accessTokenPublicKey"), decoded = _a.decoded, expired = _a.expired;
                if (decoded) {
            ...
            case 1:
                ...
                result = (0, jwt_utils_1.verifyJwt)(newAccessToken, "accessTokenPublicKey");
